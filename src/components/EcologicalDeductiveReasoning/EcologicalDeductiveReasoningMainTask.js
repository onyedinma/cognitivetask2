  ...
  const mainPuzzles = [
    ...
    },
    {
      ...
      cards: [
        ...
        { front: "Treats children", back: "Treats children", type: "image", image: require('./deducimages/doctor-patient.jpg') },
    ...
    },
    {
      ...
      cards: [
        { front: "Barks", back: "Barks", type: "image", image: require('./deducimages/dog-barking.jpg') },
        { front: "Doesn't bark", back: "Doesn't bark", type: "image", image: require('./deducimages/cat.jpg') },
